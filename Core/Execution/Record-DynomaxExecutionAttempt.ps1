...
[ordered]@{ classification=$classification; retryable=[bool]$retryable; evidenceRetained=[bool]$evidenceRetained; timedOut=[bool]$timedOutValue; record=$record } | ConvertTo-Json -Depth 20 -Compress
