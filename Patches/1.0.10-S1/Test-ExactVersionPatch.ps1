...
Write-Host '[SecretBridgeContract] PASS: database runtime bridge plus masked context-to-Browser secret filling are present; Playwright debug logging is not enabled.' -ForegroundColor Green
exit 0
