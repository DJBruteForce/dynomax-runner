...
SELECT tr.RunId,p.ProjectKey,p.DisplayName AS ProjectName,w.WorkflowKey,w.DisplayName AS WorkflowName,
...
SELECT ar.ActionRunId,ar.StepOrder,ar.ActionKey,ar.Status,ar.IsCleanup,ar.StartedAtUtc,ar.EndedAtUtc,
       ar.Message,ar.OutputJson,av.VersionNumber AS ActionVersion,av.Engine,av.EntryPoint,
       av.DefinitionHash,av.ImplementationHash
