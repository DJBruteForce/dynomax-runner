...
public sealed class ProjectContextRepository : Entity
{
        ...
        string defaultBranchHeadSha, string? defaultTreeSha, Guid credentialSecretReferenceId, Guid createdByUserId, DateTime createdAtUtc)
    {
        ...
        DefaultBranch = RepositoryEntityValues.Required(defaultBranch, 255, nameof(defaultBranch));
        DefaultBranchHeadSha = RepositoryEntityValues.Sha(defaultBranchHeadSha, nameof(defaultBranchHeadSha));
    ...
    public string DefaultBranchHeadSha { get; private set; } = string.Empty;
